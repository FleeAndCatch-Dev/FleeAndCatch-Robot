...
public class Interpreter {
	...
	public String interpret(String pCommand, DataOutputStream pOutputStream) throws ParseCommand, JSONException, IOException{
			...
			if(Objects.equals("Get", typeCmd)){
				...
				if(Objects.equals("client", id)){				
					...
					if(Objects.equals("type", type)){
						client.sendCmd(pOutputStream, "{\"id\":\"Client\",\"type\":\"SetType\",\"apiid\":\"@@fleeandcatch@@\",\"errorhandling\":\"ignoreerrors\",\"client\":{\"id\":" + String.valueOf(client.getId()) + ",\"type\":\"ThreeWheelDriveRobot\"}}");
						return null;
					}
				}
			}
